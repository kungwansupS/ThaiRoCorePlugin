...
public enum ItemAttributeType {
    ...
    // Gear Bonuses
    STR_GEAR("STRBonusGear", "§cSTR Bonus", Material.IRON_BLOCK, "%.0f", 1.0, 10.0),
    AGI_GEAR("AGIBonusGear", "§bAGI Bonus", Material.FEATHER, "%.0f", 1.0, 10.0),
    VIT_GEAR("VITBonusGear", "§aVIT Bonus", Material.IRON_CHESTPLATE, "%.0f", 1.0, 10.0),
    INT_GEAR("INTBonusGear", "§dINT Bonus", Material.ENCHANTED_BOOK, "%.0f", 1.0, 10.0),
    DEX_GEAR("DEXBonusGear", "§6DEX Bonus", Material.BOW, "%.0f", 1.0, 10.0),
    LUK_GEAR("LUKBonusGear", "§eLUK Bonus", Material.RABBIT_FOOT, "%.0f", 1.0, 10.0),
    ...
    PDMG_PERCENT("PDmgBonusPercent", "§aP.DMG Bonus %", Material.DIAMOND_SWORD, "%.1f%%", 1.0, 10.0),
    MDMG_PERCENT("MdmgBonusPercent", "§bM.DMG Bonus %", Material.DIAMOND_HOE, "%.1f%%", 1.0, 10.0),

    FINAL_DMG_PERCENT("FinalDmgPercent", "§6Final DMG %", Material.GOLD_INGOT, "%.1f%%", 1.0, 10.0),
    FINAL_DMG_RES_PERCENT("FinalDmgResPercent", "§6Final DMG RES %", Material.GOLD_BLOCK, "%.1f%%", 1.0, 10.0),
    ...
    P_PEN_PERCENT("PPenPercent", "§6P.Pen %", Material.IRON_INGOT, "%.1f%%", 1.0, 10.0),
    M_PEN_PERCENT("MPenPercent", "§6M.Pen %", Material.DIAMOND, "%.1f%%", 1.0, 10.0),
    ...
    VAR_CT_PERCENT("VarCTPercent", "§dVariable CT %", Material.CLOCK, "%.1f%%", 1.0, 10.0),
    VAR_CT_FLAT("VarCTFlat", "§dVariable CT Flat (s)", Material.CLOCK, "%.1f", 0.1, 10.0),
    FIXED_CT_PERCENT("FixedCTPercent", "§dFixed CT %", Material.COMPASS, "%.1f%%", 1.0, 10.0),
    FIXED_CT_FLAT("FixedCTFlat", "§dFixed CT Flat (s)", Material.COMPASS, "%.1f", 0.1, 10.0),
    ...
    LIFESTEAL_P_PERCENT("LifestealPPercent", "§cP. Lifesteal %", Material.POISONOUS_POTATO, "%.1f%%", 1.0, 10.0),
