...
public class SqlStorage implements PlayerDataStorage {
    ...
    private void createTable() {
        String sql = "CREATE TABLE IF NOT EXISTS " + tablePrefix + "players (" +
                ...
                "agi INT DEFAULT 1, " +
                "vit INT DEFAULT 1, " +
                "intel INT DEFAULT 1, " + // 'int' is reserved keyword, using 'intel'
                "dex INT DEFAULT 1, " +
                "luk INT DEFAULT 1, " +
                "active_effects TEXT" + // Store JSON
                ");";
    ...
    public void saveData(Player player) {
        ...
        // Using INSERT OR REPLACE (SQLite) or ON DUPLICATE KEY UPDATE (MySQL)
        // For compatibility, we'll check existence or use a merge query.
        // A generic approach compatible with both is hard without specific syntax.
        // But since we use simple structure, let's use standard INSERT / UPDATE logic or REPLACE INTO (MySQL/SQLite supports REPLACE)
